...
def test_PricePhase():
    ...
    expectedRegressionCoef = np.array([[0,2.038,-1.070],
                                      [0,-3.335,2.983],
                                      [0,1.356,-1.813]])
    learningPaths = np.array([[1,1.09,1.08,1.34],
                             [1, 1.16,1.26,1.54],
                             ...
                             [1, 0.92, 0.84, 1.01],
                             [1, 0.88, 1.22, 1.34]])
    priceAmerOption = LSM.priceAmericanOption(coefficientMatrix=expectedRegressionCoef, simulatedPaths=learningPaths, Option=putOption, MarketVariables=marketVariablesEX)
