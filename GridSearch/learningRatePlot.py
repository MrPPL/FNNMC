...
errorCallMax2 = mixEpochCallMax2-priceCallMax2
...
plt.grid(True)
pathToSave = f'C:\\Users\\HY34WN\\OneDrive - Aalborg Universitet\\Documents\\PhD\\My_Papers\\FFNNMC\\Illustration\\GridSearch\\LearningRate\\mixEpochFigure.png'
...
plt.ylabel('Error', fontsize=11)
plt.grid(True)
pathToSave = f'C:\\Users\\HY34WN\\OneDrive - Aalborg Universitet\\Documents\\PhD\\My_Papers\\FFNNMC\\Illustration\\GridSearch\\LearningRate\\figure.png'
plt.savefig(pathToSave)
plt.show()