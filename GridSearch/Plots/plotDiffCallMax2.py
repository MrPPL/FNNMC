...
data = pd.read_excel(r'C:\Users\HY34WN\OneDrive - Aalborg Universitet\Documents\PhD\My_Papers\FFNNMC\gridSearch.xlsx', sheet_name='reProduceCallMax2')
...
plt.legend()
plt.title('Grid Seach Call Max 2')
plt.xlabel('Hidden Layers')
plt.ylabel('Difference from True Price')
pathToSave = f'C:\\Users\\HY34WN\\OneDrive - Aalborg Universitet\\Documents\\PhD\\My_Papers\\FNNMC_v2\\Illustration\\GridSearch\\CallMax2\\diffPlot.eps'
